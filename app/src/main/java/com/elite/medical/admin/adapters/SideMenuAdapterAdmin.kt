...
class SideMenuAdapterAdmin(
    ...
    private val groupIcons: Map<String, Int> = mapOf(
        ...
        "Job Applicants" to R.drawable.sm_1_6,
        "Nurse Approval" to R.drawable.sm_2_1,
        "Clinic Approval" to R.drawable.sm_2_2,
        "Job Approval" to R.drawable.sm_2_3,
        "Employment Approval" to R.drawable.sm_2_4,
        "Job Search Approval" to R.drawable.sm_2_5,
        "Nurse Review" to R.drawable.sm_3,
        "Clinic Review" to R.drawable.sm_3
    )
