...
import com.elite.medical.admin.ui.sidemenu.approvals.details.jobsearchdetails.JobSearchJobDetails
...
class ApprovalJobSearchAdapter(
    private val items: ArrayList<NurseDetailJobSearch>,
    val context: Context,
    private val detailed: Boolean
) :
    RecyclerView.Adapter<ApprovalJobSearchAdapter.ModelViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ModelViewHolder, position: Int) {
        ...
        holder.label4.text = "Approval Status"
        ...
        holder.tv1.text = item.nurse.name
        holder.tv2.text = item.nurse.email
        holder.tv3.text = item.nurse.address
        holder.tv4.text = item.availabilityApproval

        holder.layout.setOnClickListener {
            val intent = Intent(context, JobSearchJobDetails::class.java)
