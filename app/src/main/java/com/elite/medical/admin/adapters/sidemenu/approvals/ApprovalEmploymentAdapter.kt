...
import com.elite.medical.admin.ui.sidemenu.approvals.details.employmentapprovaldetails.EmploymentApprovalJobDetails
...
class ApprovalEmploymentAdapter(
    private val items: ArrayList<EmploymentDetailsFromEmploymentApprovalModel>,
    val context: Context,
    private val detailed: Boolean
) :
    RecyclerView.Adapter<ApprovalEmploymentAdapter.ModelViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ModelViewHolder, position: Int) {
        ...
        holder.label5.text = "Nurse Name"
        holder.label6.text = "Request Type"
        holder.label7.text = "Approval Status"
        holder.label8.text = "Vacancy"
        holder.label9.text = "Applied"
        holder.label10.text = "Status"

        holder.tv1.text = item.job.title
        holder.tv2.text = item.job.type
        holder.tv3.text = item.clinic.name
        holder.tv4.text = item.clinic.clinicType
        holder.tv5.text = item.nurse.name
        holder.tv6.text = item.request_type
        holder.tv7.text = item.approvalStatus


        holder.layout.setOnClickListener {
            val intent = Intent(context, EmploymentApprovalJobDetails::class.java)
