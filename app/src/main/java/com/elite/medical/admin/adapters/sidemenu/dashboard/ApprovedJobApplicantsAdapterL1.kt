...
import com.elite.medical.admin.ui.sidemenu.dashboard.jobapplicants.AllJobApplicants
...
class ApprovedJobApplicantsAdapterL1(
    private val context: Context,
    private val items: List<AllJobApplicant>
) : RecyclerView.Adapter<ApprovedJobApplicantsAdapterL1.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.label2.text = "Job Title"
        holder.label3.text = "Job Type"
        holder.label4.text = "Job Created At"
        ...
        holder.tv1.text = item.clinicName
        holder.tv2.text = item.jobTitle
        holder.tv3.text = item.jobType
        holder.tv4.text = item.jobCreatedAt

        val nursesDetailsWithJobID = items[position]
        holder.layout.setOnClickListener {
            val intent = Intent(context, AllJobApplicants::class.java)
            intent.putExtra("jobAndNurseDetails", nursesDetailsWithJobID)
