...
class NurseReviewsMyJobsAdapter(
    private val listItem: List<NurseDetailsNReviewsModel.Nurse.NurseReview>,
    private val context: Context
) : RecyclerView.Adapter<NurseReviewsMyJobsAdapter.ViewHolder>() {
