...
class EnrolledNursesAdapter(private val nurses: List<Nurse>, private val context: Context):
        RecyclerView.Adapter<EnrolledNursesAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding=CustomTableItemWArrowBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            val intent=Intent(context,ActivityEnrolledNurseDetails::class.java)
            intent.putExtra("Nurse_id",nurses[position].id)
