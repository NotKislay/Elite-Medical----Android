...
class NurseRevByClinicFromAvlNurseDetlsAdapter(private val cardItems: ArrayList<ClinicReviewFromClinicReviewModel>, private val context: Context) :
    RecyclerView.Adapter<NurseRevByClinicFromAvlNurseDetlsAdapter.ModelViewHolder>() {
